<?php
	...
	$query1=mysqli_query($conn,"select * from patient where patientname='$name'");
	...
	if (isset($_POST['update'])) {
						...
						$sql = "update patient set patientname = '$name' where patientid = '$id'";
...
<body>
				...
				<input type="text" class="form-control" name="patientname" placeholder="Name" value="<?php echo query1['patientname']; ?>">
				...
				<input type="text" class="form-control" name="patientbillhistory" placeholder="Bill History">
				 ...
				 <button type="submit" class="btn btn-success" name="update">Submit</button> </button>
